                ...
                <a :href="eventSlug(event.slug)" >
                    ...
                    <div class="lgx-event__info">
                        ...
                        <div class="meta-wrapper">
                            ...
                            <span v-if="event.start_date != event.end_date">{{ changeDateFormat(convert_date_to_local(event.end_date), "YYYY-MM-DD")}} </span>
                            <span v-else>{{ changeTimeFormat(event.start_time)}} - {{ changeTimeFormat(event.end_time)}} </span>
