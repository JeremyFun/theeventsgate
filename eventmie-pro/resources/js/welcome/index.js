...
Vue.component('event-listingForComponentEvent', require('../common_components/EventListingForComponentEvent').default);
Vue.component('header-top', require('../common_components/HeaderTop').default);
