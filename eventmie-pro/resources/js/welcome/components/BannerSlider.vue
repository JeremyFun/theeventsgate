    ...
    >
        ...
        >
            <div class="slider-text-single">
                <figure>
                    <img :src="'/storage/'+item.image" alt="" class="banner-img">
                    <figcaption>
                                    ...
                                    <div class="lgx-banner-info">
                                        ...
                                        <div class="action-area">
                                            <div class="lgx-video-area" v-if="demo_mode">
                                                ...
                                                <a class="lgx-btn lgx-btn-primary" target="_blank" href="https://eventmie-pro-docs.classiebit.com/docs/1.6/changelog/changes"><i class="fas fa-book"></i> See What's New v1.6</a>
                                            </div>
