<template>
    <div class="container-fluid">
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-lg-2 mb-50 pl-30">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" v-model="f_city" :placeholder="trans('em.city')">
                </div>
            ...
            <div class="col-12 col-lg-8">
                <event-listingForComponentEvent :events ="events" :currency="currency"></event-listingForComponentEvent>
    ...
    methods: {
        ...
        setQueryString(){
            ...
            this.f_price     = (typeof this.price !== 'undefined') ? decodeURIComponent(this.price) : '';
             ...
             // set city
            this.f_city      = (typeof this.city !== 'undefined') ? decodeURIComponent(this.city) : '';
