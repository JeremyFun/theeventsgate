            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="section-btn-area">
                                                   <a class="lgx-btn" href="{{route('eventmie.get_posts')}}"><i class="fab fa-youtube"></i> Demo Video</a>
                                                </div>
                    </div>
                </div>
                <!--//.ROW-->
